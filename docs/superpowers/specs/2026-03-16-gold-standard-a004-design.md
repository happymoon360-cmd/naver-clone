...
| # | id | author | content | parentId | likes | isLiked | purpose |
|---|-----|--------|---------|----------|-------|---------|---------|
| 1 | 1 | g90주인장 | "다이소 방향제 저도 써봤는데 딱 일주일이더군요." | — | 4 | false | 공감 + credibility |
| 2 | 2 | 깔끔한드라이버 | "맞습니다. 처음엔 괜찮았는데 금방 퍼지더군요." | 1 | 1 | false | 블로거 호응 (링크 없음) |
| 3 | 3 | GV80입문자 | "지금 쓰시는 거 어디서 구하셨나요? 선 없는 타입 맞나요?" | — | 2 | false | 자연스러운 구매 질문 |
| 4 | 4 | 깔끔한드라이버 | "여기서 봤습니다. https://sjhur3601.cafe24.com/ 태양열이라 선 연결 없습니다." | 3 | 1 | false | **유일한 링크** |
| 5 | 5 | 보배드림러 | "번호판 겸용이라는 게 신기하네요. 저도 따로 두는 거 정리하려고 했는데." | — | 2 | false | 잡담 + 사회적 증거 |

**Comment timestamp pattern** (base: `Date.now() - 8 * 86400000`):
- Comment 1: `Date.now() - 8 * 86400000 + 3 * 3600000`
- Comment 2: `Date.now() - 8 * 86400000 + 5 * 3600000` (블로거 답글)
- Comment 3: `Date.now() - 8 * 86400000 + 27 * 3600000`
- Comment 4: `Date.now() - 8 * 86400000 + 30 * 3600000` (블로거 답글)
- Comment 5: `Date.now() - 8 * 86400000 + 52 * 3600000`

...
### 톤 공통 규칙 (Blog A)
- 어미: 합니다체 (~습니다, ~더군요, ~편이었습니다)
- 감정 표현: 없거나 최소화
- 보배드림 톤: 짧은 문장, 구체적 수치/데이터
...
| Block | 역할 | 내용 |
|-------|------|------|
| 1 | 도입 | 비교 동기 제시. "몇 가지 써봤습니다" 식 진입 |
| 2 | 이미지 | 비교 대상 전체 또는 첫 번째 제품 사진 |
| 3 | 비교 대상 A | 첫 번째 옵션 장단점. 수치 포함 |
| 4 | 비교 대상 B | 두 번째 옵션 장단점. 수치 포함 |
| 5 | 비교 대상 C (선택) | 세 번째 옵션 또는 추가 비교 포인트 |
| 6 | 이미지 | 비교 중간 시각 자료 |
| 7 | 종합 비교 | 항목별 비교표 또는 정리 |
| 8 | 이미지 | 현재 사용 중인 제품 사진 |
| 9 | 결론 | 균형 잡힌 마무리. 특정 제품 강추 금지 |
| 10 | SEO 정리 | 키워드 재삽입. 담백한 요약 |

**제품 노출:** ~20%. 제품은 여러 비교 대상 중 하나로 동등하게 취급.

**끝:** 균형 잡힌 결론. "상황에 따라 다릅니다" 식 마무리.

**톤:** 보배드림 비교 게시글 톤. "A는 이렇고 B는 이렇습니다." 감정 배제, 수치 중심.
...
| Block | 역할 | 내용 |
|-------|------|------|
| 1 | 에피소드 시작 | 일상 장면으로 진입. 차량/운전 관련 에피소드 |
| 2 | 이미지 | 에피소드 장면 사진 |
| 3 | 에피소드 전개 | 상황 설명. 구체적 장소/시간/수치 |
| 4 | 에피소드 전개 | 디테일 추가. 관련 경험 |
| 5 | 에피소드 전환 | 이야기 흐름 속 자연스러운 전환점 |
| 6 | 이미지 | 전환 장면 사진 |
| 7 | 에피소드 마무리 | 이야기 결말. 제품은 배경 소품 수준 |
| 8 | 이미지 | 에피소드 관련 마무리 사진 |
| 9 | 소감 | 에피소드에 대한 짧은 소감 |
| 10 | 정리 | 에피소드 결론. SEO 키워드 자연 삽입 |

**제품 노출:** ~10%. 제품은 에피소드의 배경 소품. 언급하되 주인공 아님.

**끝:** 에피소드 결론. "그런 하루였습니다" 식 마무리.

**톤:** 담백한 일상 기록. 보배드림 "오늘 드라이브" 게시글 톤. 짧은 문장, 감정 최소화.
...
| Block | 역할 | 내용 |
|-------|------|------|
| 1 | 실패 도입 | 실패 경험의 배경 설명 |
| 2 | 이미지 | 실패 관련 사진 |
| 3 | 시도 과정 | 무엇을 어떻게 시도했는지. 수치 포함 |
| 4 | 실패 진행 | 문제 발생 과정. 구체적 수치/기간 |
| 5 | 실패 확정 | 최종 실패 확인. 텐션 피크 |
| 6 | 이미지 | 실패 결과 사진 |
| 7 | 실패 분석 | 왜 실패했는지 분석. 데이터 기반 |
| 8 | 이미지 | 분석 관련 시각 자료 |
| 9 | 교훈 | 실패에서 얻은 교훈. 구체적 |
| 10 | 정리 | 다른 사람에게 전하는 팁. SEO 키워드 삽입 |

**제품 노출:** ~5%. 제품 언급 없거나 힌트 수준. 실패 경험 자체가 주인공.

**끝:** 실패 교훈 마무리. "이런 실수는 안 하는 게 좋겠습니다" 식.

**톤:** 건조한 회고. "결론부터 말하면 실패했습니다" 식 직설적 진입. 수치로 실패를 증명.
...
| Block | 역할 | 내용 |
|-------|------|------|
| 1 | 주제 도입 | 팁 주제 소개. "정리해봤습니다" 식 진입 |
| 2 | 이미지 | 주제 관련 대표 사진 |
| 3 | 팁 1 | 첫 번째 팁. 구체적 수치/방법 |
| 4 | 팁 2 | 두 번째 팁. 구체적 수치/방법 |
| 5 | 팁 3 | 세 번째 팁 (제품 카테고리가 포함될 수 있음) |
| 6 | 이미지 | 팁 관련 사진 |
| 7 | 팁 4-5 | 추가 팁. 또는 팁 간 비교 |
| 8 | 이미지 | 팁 적용 결과 사진 |
| 9 | 요약 | 팁 요약. 핵심만 재정리 |
| 10 | 마무리 | 일반적 조언. SEO 키워드 삽입 |

**제품 노출:** ~15%. 제품 카테고리가 3~5개 팁 중 하나로 등장. 직접 추천 금지.

**끝:** 일반적 조언 마무리. "참고하시면 됩니다" 식.

**톤:** 정보 전달형. 보배드림 "꿀팁 공유" 게시글 톤. 번호 매기기, 짧은 문장, 수치 중심.
...
| Block | 역할 | 내용 |
|-------|------|------|
| 1 | 사용 배경 | 제품을 쓰게 된 배경. 발견 서사 없음. 바로 진입 |
| 2 | 이미지 | 제품 사용 장면 사진 |
| 3 | 사용 초기 | 처음 사용 소감. 수치 포함 (기간, 가격 등) |
| 4 | 사용 중기 | 일정 기간 후 변화. 구체적 수치 |
| 5 | 장점 | 실제 장점. 과장 없이 사실 위주 |
| 6 | 이미지 | 사용 중 장면 사진 |
| 7 | 단점/아쉬운 점 | 솔직한 단점. 공정성 확보 |
| 8 | 이미지 | 현재 상태 사진 |
| 9 | 종합 소감 | 전체 사용 소감. 절제된 표현 |
| 10 | 정리 | 추천 대상 정리. SEO 키워드 삽입 |

**제품 노출:** ~25%. 제품이 주제이나 발견 아크 없음. 일상 속 사용 맥락.

**끝:** 담백한 사용 소감. "계속 쓸 것 같습니다" 또는 "상황에 따라 다릅니다" 식.

**톤:** 보배드림 후기 게시글 톤. 장단점 균형. 짧은 문장. 수치 필수. 감정 표현 금지.

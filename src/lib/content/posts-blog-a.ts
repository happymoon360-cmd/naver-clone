    ...
    content: [
      {
        ...
        type: 'text',
        content:
          'G80 출고하고 나서 제일 먼저 본 곳이 대시보드였습니다. 새 차 냄새보다도 임시로 올려둘 물건이 더 신경 쓰이더군요. 주차할 때 쓸 번호는 필요하고, 차 안 공기도 너무 밋밋하게 두긴 싫었습니다. 그래서 처음엔 따로따로 올려두고 이 정도면 된다 싶었습니다.',
      },
      {
        id: 'a001-2',
        type: 'image',
        src: '/posts/a-001-01.jpg',
        caption: '출고 첫날 대시보드 모습',
      },
      {
        id: 'a001-3',
        type: 'text',
        content:
          '처음에는 종이에 번호를 적어두고 작은 방향 용품도 하나 올려뒀습니다. 당장 필요한 기능은 다 있었고, 출고 직후라 뭐든 새것처럼 보여서 크게 거슬리지 않았습니다.',
      },
      {
        id: 'a001-4',
        type: 'text',
        content:
          '처음 이틀 정도는 괜찮았습니다. 차에 탈 때마다 번호를 다시 펴놓는 것도 잠깐이면 됐고, 향도 은은하게 도는 편이었습니다.',
      },
      {
        id: 'a001-5',
        type: 'text',
        content:
          '그런데 며칠 지나니 대시보드 위가 생각보다 빨리 어수선해집니다. 종이는 문 열고 닫을 때마다 자리가 틀어지고, 따로 둔 물건은 닦을 때마다 손이 한 번 더 갔습니다. 새 차인데도 정리 안 된 느낌이 먼저 보였습니다. 결국 한 번에 정리할 방법을 찾게 됐습니다.',
      },
      {
        id: 'a001-6',
        type: 'image',
        src: '/posts/a-001-02.jpg',
        caption: '임시로 올려둔 번호판과 소품',
      },
      {
        id: 'a001-7',
        type: 'text',
        content:
          '그러다 햇빛만 들어오면 알아서 움직이는 선 없는 타입을 알게 됐습니다. 번호 확인용까지 같이 들어가 있으니 따로 올려둘 게 줄었고, 대시보드 위가 훨씬 단정해 보였습니다. 제 차에서는 이 한 가지가 가장 먼저 자리 잡았습니다.',
      },
      {
        id: 'a001-8',
        type: 'image',
        src: '/posts/a-001-03.jpg',
        caption: '정리 후 대시보드에 남긴 한 가지',
      },
      {
        id: 'a001-9',
        type: 'text',
        content:
          '지금도 출고 직후 제일 먼저 한 걸 묻는다면 대시보드 정리라고 합니다. 물건을 더 붙인 게 아니라 줄였을 뿐인데, 차 안 인상이 훨씬 깔끔해졌습니다. 운전할 때 시선이 덜 분산되는 것도 나쁘지 않았고요.',
      },
      {
        id: 'a001-10',
        type: 'text',
        content:
          '새차를 받으면 이것저것 바로 사고 싶어집니다. 그런데 제 기준에선 새차일수록 임시로 두는 것부터 빨리 정리하는 게 낫습니다. 따로 올려둘 물건을 줄여두면 첫날 느낌이 더 오래 갑니다.',
      },
    ],
    comments: [
      {
        id: 1,
        content: '저도 출고 첫날은 종이 번호 적어뒀다가 이틀 만에 보기 싫어지더군요.',
        author: '제네시스매니아',
      ...
      {
        id: 2,
        content: '맞습니다. 새 차일수록 임시로 둔 게 더 눈에 들어옵니다.',
        author: '깔끔한드라이버',
      ...
      {
        id: 3,
        content: '지금 올려두신 거 선 없는 타입 맞나요? 번호 확인도 같이 되나요?',
        author: 'GV70대기중',
      ...
      {
        id: 4,
        content: '여기서 봤습니다. https://sjhur3601.cafe24.com/ 태양열이라 선 연결 없고 번호 확인도 됩니다.',
        author: '깔끔한드라이버',
      ...
      {
        id: 5,
        content: 'G80 대시보드가 넓어서 그런지 하나만 줄여도 훨씬 깔끔해 보이더군요.',
        author: '보배드림러',
